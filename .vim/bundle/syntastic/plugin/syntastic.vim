...
if g:syntastic_enable_signs
    ...
    exe 'sign define SyntasticError text='.g:syntastic_error_symbol.' texthl=DiffDelete'
    exe 'sign define SyntasticWarning text='.g:syntastic_warning_symbol.' texthl=DiffChange'

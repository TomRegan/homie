...
;;; Commentary:
;;; Configuration is split into modules, see below.
...
(custom-set-variables
 ...
 '(menu-bar-mode nil)
 '(safe-local-variable-values (quote ((encoding . utf-8) (eval c-set-offset (quote class-close) 2) (eval c-set-offset (quote class-open) 2) (eval c-set-offset (quote access-label) 0) (eval c-set-offset (quote substatement-open) 2) (eval c-set-offset (quote case-label) 0) (require-final-newline . t))))
 '(tool-bar-mode nil)
